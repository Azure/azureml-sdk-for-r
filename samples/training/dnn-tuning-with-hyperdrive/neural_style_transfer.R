# Modified from https://github.com/rstudio/keras/blob/master/vignettes/examples/neural_style_transfer.R
...
total_variation_weight <- args[2]
style_weight <- args[3]
content_weight <- args[4]
...
log_metric_to_run("Loss", loss, current_run) # log metrics to AzureML
