...
# inference team suggest to use model's file name as model name because of some known issue
...
# 2) Please note that you have to specify the source_directory in order to deploy more than one file
