...
If using a CRAN installation with `reticulate < 1.14` or a GitHub installation, by default, the correct conda environment will be selected automatically. There is no need to specify the `envname` parameter.
