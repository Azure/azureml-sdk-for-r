...
In order to collect and upload run metrics, we need to import the `azureml` package at the top of our training script, ["cifar10_cnn.R"](../../samples/training/cnn-tuning-with-hyperdrive/cifar10_cnn.R).
