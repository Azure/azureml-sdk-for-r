...
### Prepare the training script
A training script called `accidents.R` has been provided for you has been provided for you in the `train-and-deploy-first-model` folder. Notice the following details **inside the training script** that have been done to leverage the Azure ML service for training:
