...
The following is an example entry script. You can see the full tutorial [here](https://azure.github.io/azureml-sdk-for-r/articles/train-and-deploy-to-aci/train-and-deploy-to-aci.html).
...
### 2. ACI deployment
For an example of deploying to ACI, see the [train-and-deploy-to-aci](https://azure.github.io/azureml-sdk-for-r/articles/train-and-deploy-to-aci/train-and-deploy-to-aci.html) vignette.
...
You can instead also create or attach an AKS cluster via the CLI or [studio](ml.azure.com) UI.

For an example of deploying to AKS, see the [deploy-to-aks](https://azure.github.io/azureml-sdk-for-r/articles/deploy-to-aks/deploy-to-aks.html) vignette.
