...
#' and we define
#' base path to be /path, when file.txt is uploaded to the file share, it will
#' have
#' the path of /to/file.txt. If target_path is also given, then it will be used
#' as
#' the prefix for the derived path from above. The base path must be a common
#' path of
#' all of the files, otherwise an exception will be thrown, defaults to None,
#' which will find
#' the common path.
...
#' download. If set to NULL, will download everything in the blob defaults to
#' NULL
