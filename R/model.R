...
#' @param name Will retrieve the latest model with the corresponding name, if it
#' exists
...
#' @param properties Optional, will filter based on the provided list, searching
#' by either 'key' or '[key, value]'.
...
#' @param target_dir Path to directory for where to download the model. Defaults
#' to "."
