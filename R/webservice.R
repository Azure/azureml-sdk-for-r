...
#' @export
get_webservice <- function(workspace, 
                           name){
  webservice <- azureml$core$Webservice(workspace, 
                                        name)
...
#' @export
wait_for_deployment <- function(webservice, 
                                show_output = FALSE){
...
#' @export
get_webservice_logs <- function(webservice, 
                                num_lines = 5000L){
...
#' @export
invoke_webservice <- function(webservice, 
                              input_data){
...
#' 'Secondary'
#' @export
generate_new_webservice_key <- function(webservice, 
                                        key_type){
...
deserialize_to_webservice <- function(workspace, 
                                      webservice_payload){
  azureml$core$Webservice$deserialize(workspace, 
                                      webservice_payload)
}
